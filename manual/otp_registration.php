            ...
            <form action="verify_otp.php" method="post">
                ...
                <div class="otp-content">
                    ...
                    <div class="text-center mb-10">
                        ...
                        <span class="remark"><b>ผ่านหมายเลขเบอร์มือถือ : <span class="text-green"><?php echo $_SESSION['wifi_form']['phone']; ?></span></b></span></br>
                        <span class="remark"><b>เลขที่อ้างอิง : <span class="otp-reference text-green"><?php echo $_SESSION['ref_code']; ?></span></b></span>
                    </div>
                ...
                <div class="otp-footer">
                    <div class="text-left">
                        <a href="registration.php" class="btn btn-secondary">ย้อนกลับ</a>
                    </div>
                    <div class="text-right">
                        <input type="hidden" id="ref_code" name="ref_code" value="<?php echo $_SESSION['ref_code']?>">
