...
// Insert into radcheck (ใช้ Crypt-Password แทน Cleartext-Password)
$stmt = $radius_conn->prepare("INSERT INTO radcheck (username, attribute, op, value) VALUES (?, 'Crypt-Password', ':=', ?)");
...
$stmt->bind_param("ssi", $rad_username, md5($rad_password), $user_id);
$stmt->execute();
$stmt->close();
