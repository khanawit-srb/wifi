...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // สร้าง salt สำหรับ SHA-512 crypt format: $6$salt$
    ...
    try {
        ...
        // --- Update wifi_registration.users (เก็บ plain password) ---
        // ถ้าต้องการเก็บรหัสผ่านแบบเข้ารหัสด้วยก็แนะนำเก็บ hash แทน แต่โค้ดนี้เก็บแบบ plain (แนะนำแก้ในอนาคต)
