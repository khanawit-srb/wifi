    ...
    <div class="form-container">
        ...
        <form method="post" class="form">
            ...
            <div class="form-group">
                ...
                <input type="password" name="current_password" required placeholder="รหัสผ่านปัจจุบัน">
            </div>
            <div class="form-group">
                <label>รหัสผ่านใหม่</label>
                <input type="password" name="new_password" required placeholder="รหัสผ่านใหม่">
            </div>
            <div class="form-group">
